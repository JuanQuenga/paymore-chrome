...
echo "**Download:** [paymore-chrome-v${NEW_VERSION}.zip](./paymore-chrome-v${NEW_VERSION}.zip)"
echo ""
echo "**What's New:**"
echo ""
echo "### Features"
...
echo "### Installation"
echo ""
echo "1. Download [paymore-chrome-v${NEW_VERSION}.zip](./paymore-chrome-v${NEW_VERSION}.zip)"
...
echo "6. Select the unzipped \`paymore-chrome\` folder"
echo ""
echo "Note: The packed version for Chrome Web Store submission is located at \`.output/paymore-chrome-v${NEW_VERSION}-packed.zip\`"
echo "---"
echo ""
